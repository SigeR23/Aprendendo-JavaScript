...
NamespaceTeste.Estado = (function() {
...
NamespaceTeste.Cidade = (function(){
	...
	function onEstadoSelecionado(evento, uf) {
		if(uf) {
			...
			//chamada de function com call/apply
			//reset.apply(this);
			reset.call(this);
	...
	function onCidadesRetornadas(cidades) {
		...
		this.comboCidade.html("<option>Selecion uma cidade</option>");
...
$(function () {
	var estado = new NamespaceTeste.Estado();
	estado.iniciar();

	var cidade = new NamespaceTeste.Cidade(estado);
	cidade.iniciar()  ;
})
